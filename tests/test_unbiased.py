...
def test_unbiased_selection_no_interaction_tests():
    ...
    for (ind_split_var, weak_split_var, strong_split_var) in results:
        big_dict_indep[ind_split_var] = big_dict_indep.get(ind_split_var,0) + 1
        big_dict_weak[weak_split_var] = big_dict_weak.get(weak_split_var,0) + 1
        big_dict_strong[strong_split_var] = big_dict_strong.get(strong_split_var,0) + 1
